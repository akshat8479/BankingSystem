...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.bankingsystem.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.bankingsystem.ViewHolder.ClickListener clickListener){
