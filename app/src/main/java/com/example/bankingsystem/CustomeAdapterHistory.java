...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.bankingsystem.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.example.bankingsystem.HistoryList historyList, List<Model> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.setOnClickListener(new com.example.bankingsystem.ViewHolder.ClickListener() {
            @Override
